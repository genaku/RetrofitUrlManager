...
//        RetrofitUrlManager.setDebug(true);
        ...
        RetrofitUrlManager.putDomain(GITHUB_DOMAIN_NAME, APP_GITHUB_DOMAIN);
        RetrofitUrlManager.putDomain(GANK_DOMAIN_NAME, APP_GANK_DOMAIN);
        RetrofitUrlManager.putDomain(DOUBAN_DOMAIN_NAME, APP_DOUBAN_DOMAIN);
    }
}
